...
description: >-
  ...
  translations for all supported locales (en, zh, zh-TW, fr, ja, ru, vi, ar). Use for any
...
- Why this is mandatory, not optional:
  - Hand-editing reliably drops one or more of the eight locales (`en`, `zh`, `zh-TW`, `fr`, `ja`, `ru`, `vi`, `ar`), leaving keys missing in some languages.
...
- Locale files: `web/src/i18n/locales/{en,zh,zh-TW,fr,ja,ru,vi,ar}.json`
...
2. Add the key via `add-missing-keys.mjs`, populating its `newKeys` object for every supported locale: `en`, `zh`, `zh-TW`, `fr`, `ja`, `ru`, `vi`, `ar`. Even one key goes through the script; do not hand-edit the JSON.
...
const locales = ['fr', 'ja', 'ru', 'zh', 'zh-TW', 'vi', 'ar']
